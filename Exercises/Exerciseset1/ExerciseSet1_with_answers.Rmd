...
1. code 'SPY = StockReturns[,"SPY"] downloads return of SPY and first company in data set which is supposedly Apple (AAPL) source is dataSet1.R


**2.Cumulative 577.2 Average 0.149 Standard deviation 2.426 **
<br>
<br>
<br>
<br>
