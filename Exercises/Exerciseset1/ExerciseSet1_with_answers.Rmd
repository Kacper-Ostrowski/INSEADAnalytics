...
**Your Answers here:**
1.
Function checks how many of of first 20 rows of stockreturns are different than first 20 rows in CSV - the result is 20 (all) there might be some rounding issue here, because normally there should be all equal hence the result should be 0
