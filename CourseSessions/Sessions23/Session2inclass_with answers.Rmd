...
No, the plotted line can never be increasing as the eigenvalues are sorted in decending order which results in a downward sloping plot. The plot can onlz be less downwoard sloping which would mean that correlations between variables are smaller.

**Q3)**
The steeper plot the better, because it enables to reduce the number of variables and have a simpler model with high explanatory power
<br>
<br>
