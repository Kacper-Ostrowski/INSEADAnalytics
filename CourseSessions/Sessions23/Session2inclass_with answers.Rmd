...
<br>
**Q1)**
Yes, for example there is 0.63 correlation between
 Q1_16_People tend to come to me for advice about boating                                 Q1_17_I consider myself more knowledgeable about boating than the rest of my boating peers

This makes sense as the content of the question is very simmilar just from a different angle

**Q2)** Correlations imply that there is potential combine the questions in blocks and hence reduce the number of variables
...
<br>
<br>
**Q1)** They are principal components (linear combinations of the original questions) and show what percentage of data variance they explain

**Q2)** No, the plotted line can never be increasing as the eigenvalues are sorted in decending order which results in a downward sloping plot. The plot can onlz be less downwoard sloping which would mean that correlations between variables are smaller.

**Q3)** The steeper plot the better, because it enables to reduce the number of variables and have a simpler model with high explanatory power
<br>
<br>
...
<br>
**Q1)**
C1: Status symbol - make business sense
C2: Fun and Adventure - makes business sense
C3: Functional/Technology - makes business sense
C4: Expert - makes sense, but significant overlap in questions with C1-C3
C5: Price sensitive - makes business sense

**Q2)**
a) 5 (eigenvalues above 1)
b) 4 (Component 4 to be excluded as it significantly overlaps with others)
c) 4

**Q3)**
Interpretation in Q1

**Q4)**
Data science is a combination of statistics and business understanding
<br>
<br>
